...
// ignore_for_file: use_key_in_widget_constructors, unused_element, duplicate_ignore, avoid_print, prefer_const_constructors, unnecessary_null_comparison
...
class _beritamdrState extends State<beritamdr> {
  ...
  final response = await http.get(Uri.parse("https://tokoonlineyanto.000webhostapp.com/listnews.php"));
          ...
          return Container(
            ...
            child: new GestureDetector(
              ...
              child: Card(
                ...
                subtitle: Text(list[i]['de_Sub']),
                leading: Image.network(list[i]['img_url'],
